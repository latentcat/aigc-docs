...
![s15](./image/light/s15.jpg)


![s33](./image/light/s33.png)
...
![s31](./image/light/s31.png)


对这张图片进行黑白，模糊处理，并扣出烟花，将他放大，得到黑白图。


![s32](./image/light/s32.png)

将黑白图放入controlnet，选择模型（可从huggingface上下载）

![s13](./image/light/s29.png)

会得到下面三张图

![s13](./image/light/s27.jpg)

![s13](./image/light/s28.jpg)

![s13](./image/light/s17.jpg)

可以看到虽然光影关系得到了保留，但是由于原人物的位置太黑了，导致 Prompt 中的 1 girl 并没有和画面联系上，所以我们需要另一个 controlnet 配合赋予正确的语义关系

![s13](./image/light/s30.png)

在使用 seg 后，两个 controlnet 配合，切换不同的底膜，可以得到如下的效果

![s13](./image/light/s18.jpg)

![s13](./image/light/s19.jpg)

![s13](./image/light/s20.jpg)

![s13](./image/light/s22.jpg)

![s13](./image/light/s24.jpg)

![s13](./image/light/s25.jpg)
...
![s13](./image/light/s13.jpg)

![s8](./image/light/s8.jpg)
...
![s9](./image/light/s9.jpg)

![s10](./image/light/s10.jpg)

![s11](./image/light/s11.jpg)

在以上三组图中可见，通过对输入内容进行白色亮点的添加，并在 Prompt 中输入漂浮的星星，就可以将其引导到白色亮点上。

![s12](./image/light/s12.jpg)

![s14](./image/light/s14.jpg)
...
![s1](./image/light/s1.png)


![s2](./image/light/s2.png)


![s3](./image/light/s3.png)


### 训练过程


![s16](./image/light/s16.jpg)

![s4](./image/light/s4.jpg)

![s5](./image/light/s5.jpg)

![s6](./image/light/s6.jpg)
